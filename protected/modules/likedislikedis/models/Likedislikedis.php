 ...
 */
class Likedislikedis extends CActiveRecord
{
	public $count;
	/**
	...
	public function rules()
	{
		...
		return array(
			array('field_id, user_ip, status', 'required'),
			...
			array('id, field_id, user_id, user_ip, status, add_timestamp, edit_timestamp', 'safe', 'on'=>'search'),
		);
	}
