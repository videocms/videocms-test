...
<div class="row">
    ...
    <div class="tab-tr" id="t1">
            <div class="like-btn"><?php $this->widget('likedislikelik.widgets.LikeDislikeButton',array('field_id'=>$ModelSite->video_id)); ?></div>
     ...
     <div class="stat-cnt">
                ...
                <div class="stat-bar">
                    <div class="bg-green" style="width:<?php $this->widget('likedislikelik.widgets.LikeDislikeView',array('field_id'=>$ModelSite->video_id)); ?>%"></div>
                ...
                <div class="like-count"><?php $this->widget('likedislikelik.widgets.LikeDislikeLike',array('field_id'=>$ModelSite->video_id)); ?></div>
     </div></div>
         <?php
