        ...
        <div class="wrapper">
            <div class="videocontent">
                <?php
                    ...
                    <video id="example-2" class="vjs-playing vjs-default-skin" <?php echo $this->player_loop; ?> preload="<?php echo $this->player_preload; ?>" controls <?php echo $this->player_autoplay; ?> width="auto" height="auto" poster="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $Model->video_image; ?>" data-setup='{ "nativeControlsForTouch": <?php echo $this->player_controls; ?>, "techOrder": ["html5","flash"], "plugins" : { "resolutionSelector" : { "default_res" : "480" } } }'>		
                        <?php      
