...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div id="wrapper">
        <div class="row">
          <div class="col-xs-5 col-sm-4 col-md-2" style="padding-top:7px; padding-left: 30px;">
              <a href="<?php echo Yii::app()->request->baseUrl; ?>/"><img src="http://alexie.pl/logo.png" alt="tekst"></a>
         </div>
    ...
    <div class="col-xs-6 col-sm-6" style="padding-top:7px;">
        ...
        <div class="like" style="display: none;"><div class="col-xs-1" style="padding-top: 3px;"><img src="<?php echo Yii::app()->request->baseUrl; ?>/css/img/OK-button.png"></div></div>
        <div class="dis-like" style="display: none;"><div class="col-xs-1" style="padding-top: 3px;"><img src="<?php echo Yii::app()->request->baseUrl; ?>/css/img/OK-button.png"></div></div>
        <div class="dis-like-dis" style="display: none;"><div class="col-xs-1" style="padding-top: 3px;"><img src="<?php echo Yii::app()->request->baseUrl; ?>/css/img/OK-button.png"></div></div>
        <div class="like-dis" style="display: none;"><div class="col-xs-1" style="padding-top: 3px;"><img src="<?php echo Yii::app()->request->baseUrl; ?>/css/img/OK-button.png"></div></div>
