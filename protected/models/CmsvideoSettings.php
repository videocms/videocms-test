...
class CmsvideoSettings extends CFormModel
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'player_controls' => 'Player mobile controls'
        );
    }
    ...
    public function SaveSettings()
    {
        ...
        $UpdateSettings->bindValue(':PlayerControls', $this->player_controls, PDO::PARAM_STR);
