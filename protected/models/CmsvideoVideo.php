...
class CmsvideoVideo extends CFormModel
{
    ...
    public function rules() {
        return array(
            array('video_title, video_text, video_category, video_image, video_thumb, video_published', 'required'),
...
//}
    ...
    {
        $AddVideo = Yii::app()->db->createCommand('INSERT INTO videocms_video (video_title, video_text, video_category, video_date, video_480p, video_720p, video_1080p, video_thumb, video_image, video_published) VALUES (:VideoTitle, :VideoText, :VideoCategory, :VideoDate, :Video480p, :Video720p, :Video1080p, :VideoThumb, :VideoImage, :VideoPublished)');
